		...
		<label for="add-tag-input" class="tag-input">
			...
			>
				{#each tags as tag, index (tag)}
					<li
						class="text-[20px] grid grid-cols-[1fr_32px] place-items-center gap-1 rounded-[0.27rem] bg-[var(--bg-color)] p-1
			...
			>
				<form action="" class="flex gap-1">
					...
					<button
						class="border-0 border-[var(--bg-color)] align-middle rounded-[0.27rem] h-[fit-content] text-white relative"
						type="button"
						id="add-tag-submit"
