...
<body class="bg-slate-950 h-screen">
	...
	<section
		class="smooth-scroll bg-slate-900 flex flex-col h-full m-auto mt-8"
	>
		<label for="add-tag-input" class="tag-input">
			<ul
				...
				class="flex flex-row flex-wrap items-center justify-center w-[80vw] bg-slate-900 gap-3 p-6 m-auto rounded-[0.27rem] overflow-auto"
			>
