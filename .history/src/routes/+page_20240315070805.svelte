			...
			>
				{#each tags as tag, index (tag)}
					<div class="flex items-center align-middle gap-0">
						...
						<span
							class=" h-[40px] box-border bg-blue-500 text-center justify-center align-middle text-[var(--text-color)] rounded-tr-[0.25rem] rounded-br-[0.25rem] w-[24px] border-[1px] border-[hsla(187,45%,84%,1)] font-[62px]"
							tabindex="0"
							role="button"
							on:click={() => remove(tag)}
							on:keydown={(e) =>
