...
<body class="bg-slate-950 h-[80vh]">
	<div class="grid place-items-center pb-0 bg-slate-900 pt-8">
		...
		>
			project made with Svelte-kit, TailwindCSS and Auto-animate.
		</p>
	</div>
	<section
	...
	>
		<label for="add-tag-input" class="tag-input">
			<ul
				...
				class="flex flex-row flex-wrap items-center justify-center w-[80vw] bg-slate-900 gap-4 h-[50vh]"
			>
			...
			>
				<label
					for="add-tag-input"
					class="pl-2 text-xl bottom-0 absolute text-fuchsia-300 font-semibold rounded-[0.27rem] bg-slate-900"
					>Add a tag</label
				>
				<form action="">
					<input
						class="border-2 border-amber-500 pl-2 pb-1 mb-1 pt-2 rounded-[0.27rem] text-white bg-slate-900"
						id="add-tag-input"
						type="text"
