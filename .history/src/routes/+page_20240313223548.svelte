		...
		<label for="add-tag-input" class="tag-input">
			...
			>
				{#each tags as tag, index (tag)}
					...
					<li
						class="flex items-center justify-center relative w-[100px] h-[20px] text-[var(--text-color)] bg-[var(--btn-bg-color)] rounded-[0.27rem] text-[14px] font-bold leading-[14px] box-border"
					>
						{tag}
						<span
							class="z-100 absolute w-[20px] right-0 cursor-pointer h-full bg-[var(--btn-bg-color)] text-[var(--text-color)]
