		...
		<label for="add-tag-input" class="tag-input">
			...
			>
				{#each tags as tag, index (tag)}
					<li
						class="text-[16px] grid grid-cols-[1fr_32px] place-items-center gap-1 rounded-[0.27rem] bg-[var(--bg-color)]
						
					  text-center w-[max-content] font-semibold leading-none text-[var(--text-color)] border-[1px] border-cyan-200 pl-2 mr-2"
					>
						{tag}
						<span
