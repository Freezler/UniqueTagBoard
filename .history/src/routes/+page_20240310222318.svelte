...
<body class="bg-slate-500">
	<header
		class="grid place-items-center h-[140px] bg-slate-900 pb-4"
	>
		<h1
				...
				{#each tags as tag, index (tag)}
					...
					>
						...
						<span
							...
							rounded-tr-[0.27rem]  rounded-br-[0.27rem] m-[0rem] text-[32px] font-thin leading-none text-amber-50 selection:border-cyan-100 pb-1"
							tabindex="0"
							role="button"
							on:click={() => remove(tag)}
							on:keydown={(e) =>
