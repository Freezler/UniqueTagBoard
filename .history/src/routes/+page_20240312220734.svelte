...
<body class="grid bg-slate-950 h-[100vh]">
	...
	>
		<label for="add-tag-input" class="tag-input">
			...
			>
				<form action="" class="flex gap-0  p-0">
					<input
					...
					<button
						class=" bg-[hsla(187,45%,14%,1)] border-4 border-[var(--bg-color)] align-center rounded-[0.27rem] text-white relative h-full w-[40px] px-1 py-1"
						type="button"
						id="add-tag-submit"
