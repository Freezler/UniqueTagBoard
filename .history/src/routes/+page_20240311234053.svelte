...
<body class="bg-slate-950 h-[80vh]">
	<div class="grid place-items-center pb-0 bg-slate-900 pt-8">
		<h1
			class="text-2xl sm:text-3xl font-semibold pt-0 uppercase text-amber-50"
		>
		Unique Tag Generator
		</h1>
		<p
			class="text-xs text-amber-50 pb-0 font-semibold w-[35ch] sm:w-[20ch] text-pretty text-center"
		>
