	...
	>
		<label for="add-tag-input" class="tag-input">
			<ul
				...
				class="overflow-scroll flex flex-row flex-wrap items-center justify-center w-[85vw] bg-pink-950/5 gap-1 h-[48vh] p-8"
			>
				{#each tags as tag, index (tag)}
				<div class="flex items-center text-pretty">
					<li
						class=" items-center justify-center  text-[var(--text-color)] bg-[var(--btn-bg-color)] rounded-[0.27rem]  font-bold  box-border"
					>
						{tag}</li>
						<span
