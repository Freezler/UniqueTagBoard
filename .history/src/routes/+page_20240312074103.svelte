	...
	>
		<label for="add-tag-input" class="tag-input">
			<ul
				...
				class="small:bg-red-500 flex flex-row flex-wrap items-center justify-center w-[80vw] bg-slate-900 gap-2 h-[40vh] mb-2"
			>
				{#each tags as tag, index (tag)}
					<li
						class="text-[16px] grid grid-cols-[1fr_32px] place-items-center gap-2 rounded-[0.27rem] bg-[var(--bg-color)] p-1
