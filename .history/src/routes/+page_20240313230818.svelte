			...
			>
				{#each tags as tag, index (tag)}
					<div class="flex items-center align-middle">
						<li class=" h-[32px] bg-[var(--btn-bg-color)] rounded-tl-[0.25rem] rounded-bl-[0.25rem] text-[var(--text-color)] pl-2 pr-2 cursor-vertical-text border-[1px] border-[hsla(187,45%,74%,1)]">
							{tag}
						</li>
						<span
