			...
			>
				{#each tags as tag, index (tag)}
					<div class="flex items-center">
						<li class=" h-[32px] bg-[var(--btn-bg-color)] rounded-tl-[0.25rem] rounded-br-[0.25rem] text-[var(--text-color)] pl-2 pr-2">
							{tag}
						</li>
						<span
							class=" h-[32px] box-border bg-blue-500 text-center justify-center align-middle text-[var(--text-color)] rounded-tr-[0.25rem] rounded-br-[0.25rem] w-[30px] "
							tabindex="0"
							role="button"
							on:click={() => remove(tag)}
							on:keydown={(e) =>
