		...
		<label for="add-tag-input" class="tag-input">
			...
			>
				{#each tags as tag, index (tag)}
					...
					<li
						class="flex-1 items-center justify-center  h-[40px] h-[24px] text-[var(--text-color)] bg-[var(--btn-bg-color)] rounded-[0.27rem] text-[14]6px] font-bold leading-[14px] box-border"
					>
						{tag}</li>
						<span
