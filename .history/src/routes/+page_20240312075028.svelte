...
<body class="grid bg-slate-950 h-full ">
	<div
		class="grid place-items-center grid-cols-1 grid-rows-2 pb-0 bg-slate-900 text-center text-amber-50 "
	>
		<h1
		...
		<p
			class="text-[6px] text-amber-50 font-thin w-[35ch] text-pretty text-center mb-4"
		>
	...
	>
		<label for="add-tag-input" class="tag-input">
			<ul
				...
				class="flex flex-row flex-wrap items-center justify-center w-[80vw] bg-slate-900 gap-2 h-[60vh] "
			>
			...
			<div
				class="  grid place-items-center relative w-[content] h-[auto] bg-pink-200/20 p-8 rounded-xl"
			>
				<label
					for="add-tag-input"
					class="text-sm bottom-[104px] absolute px-2 py-1 text-pink-300 font-semibold rounded-[0.27rem] bg-indigo-700"
