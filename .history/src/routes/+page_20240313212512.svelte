	...
	>
		<label for="add-tag-input" class="tag-input">
			...
			>
					...
					<input
						class="flex-1 h-[40px] bg-[var(--btn-bg-color)] text-[var(--text-color)] m-[5px] box-border"
						id="add-tag-input"
						type="text"
					...
					<button
						class="flex-1 pl-2 pr-2 h-[40px] bg-[var(--btn-bg-color)] text-[var(--text-color)] m-[5px] box-border rou"
						type="button"
						id="add-tag-submit"
