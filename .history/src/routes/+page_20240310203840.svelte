		...
		>
			{#each tags as tag, index (tag)}
				<li
					...
					pb-[0.45em] m-[24px] py-[0.35em] pt-[0.35em] pl-2 pr-2 text-center align-baseline text-[0.75em] font-bold leading-none text-[var(--text-color)] border-2 border-cyan-600"
				>
					{tag}
					<span
