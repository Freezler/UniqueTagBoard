			...
			>
				{#each tags as tag, index (tag)}
					<li
					    ...
					    text-start w-[max-content] font-semibold leading-none text-[var(--text-color)] border-[1px] border-cyan-200 pl-2 mr-2"
					>
						{tag}
						<span
						  ...
						  text-amber-50 selection:border-cyan-100 n]    pb-1  pl-1 pr-1"
							tabindex="0"
							role="button"
							on:click={() => remove(tag)}
							on:keydown={(e) =>
