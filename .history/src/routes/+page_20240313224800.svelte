		...
		<label for="add-tag-input" class="tag-input">
			...
			>
				...
				<div class="flex items-center">
					<li
						class="flex-1 items-center justify-center  text-[var(--text-color)] bg-[var(--btn-bg-color)]   font-bold  box-border"
					>
						{tag}</li>
						<span
							class="flex-1 z-100  bg-[red] text-[var(--text-color)]  right-0
