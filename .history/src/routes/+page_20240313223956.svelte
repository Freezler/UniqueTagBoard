		...
		<label for="add-tag-input" class="tag-input">
			...
			>
				{#each tags as tag, index (tag)}
					...
					<li
						class="absolute flex items-center justify-between  pl-2 pr-2  h-[32px] text-[var(--text-color)] bg-[var(--btn-bg-color)] rounded-[0.27rem] text-[14]6px] font-bold leading-[14px] box-border"
					>
						{tag}
						<span
							class="z-100 w-[20px] cursor-pointer h-full bg-[var(--bg-color)] text-[var(--text-color)] relative right-0
