			...
			>
				{#each tags as tag, index (tag)}
					<li
					    ...
					    text-start w-[calc(content+62px)] font-semibold leading-none text-[var(--text-color)] border-[1px] border-cyan-200 pl-2  mb-1"
					>
						{tag}
						<span
						  ...
						  text-amber-50 selection:border-cyan-100 pb-1 pl-1 pr-0"
							tabindex="0"
							role="button"
							on:click={() => remove(tag)}
							on:keydown={(e) =>
