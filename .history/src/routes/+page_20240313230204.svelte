	...
	>
		<label for="add-tag-input" class="tag-input">
			<ul
				...
				class="overflow-scroll flex flex-row flex-wrap items-center justify-center w-[85vw] bg-pink-950/5 gap-2 h-[50vh] p-8 border-[1px]"
			>
				{#each tags as tag, index (tag)}
					<div class="flex items-center box-border">
						...
						<span
							class=" h-[32px] box-border bg-blue-500 text-center justify-center align-middle text-[var(--text-color)] rounded-tr-[0.25rem] rounded-br-[0.25rem] w-[32px]"
							tabindex="0"
							role="button"
							on:click={() => remove(tag)}
							on:keydown={(e) =>
