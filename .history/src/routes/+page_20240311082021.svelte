...
<body class="bg-slate-950 h-screen">
	...
	<section
		class="smooth-scroll bg-slate-900 flex flex-col h-[calc(100vh-156px)] m-auto mt-32"
	>
		<label for="add-tag-input" class="tag-input">
			...
			<div
				class=" fixed bottom-24 grid place-items-center left-0 w-full h-[6rem] bg-slate-900"
			>
				<label
					for="add-tag-input"
