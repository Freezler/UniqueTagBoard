...
<body class="grid bg-slate-950 h-[100vh] scroll-smooth">
	...
	>
		<h1
			class="text-3xl font-semibold p-2 uppercase text-[hsla(187,45%,84%,1)]  text-center mb-4"
		>
			Unique Tag Board
		</h1>
		<p
			class="text-[16px] text-[hsla(187,45%,64%,1)] font-normal w-[32ch] text-pretty text-center mb-4"
		>
