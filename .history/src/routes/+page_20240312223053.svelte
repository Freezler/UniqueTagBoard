<script>
	...
	let tags = [
		["AutoAnimate","AWS","C","C#","cobolt","ESLint","Figma","Fortran","GitHub","Java","MongoDB","Mongoose","mySql","Netlify","NodeJS","NPM","Nuxt","PHP","Postgress","Prettier","Python","randy","React","React Native","Svelte","SvelteKit","SyntaxFM","TailwindCSS","Vercel","VSCode","Vue3"]
	];
