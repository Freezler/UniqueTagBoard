...
<body class="bg-slate-950 h-[100vh]">
	...
	<section
		class="smooth-scroll bg-slate-900 flex flex-col h-[100vh] m-0 mt-0"
	>
		<label for="add-tag-input" class="tag-input">
			<ul
				...
				class="flex flex-row flex-wrap items-center justify-center w-[80vw] bg-slate-900 gap-2 h-[40vh] "
			>
