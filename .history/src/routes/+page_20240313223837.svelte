		...
		<label for="add-tag-input" class="tag-input">
			...
			>
				{#each tags as tag, index (tag)}
					...
					<li
						class="flex items-center justify-between  w-[120px] h-[32px] text-[var(--text-color)] bg-[var(--btn-bg-color)] rounded-[0.27rem] text-[14px] font-bold leading-[14px] box-border"
					>
						{tag}
						<span
