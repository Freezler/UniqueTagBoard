...
<body class="bg-slate-950 h-[80vh]">
	<div class="grid place-items-center pb-0 bg-slate-900 pt-8">
		<h1
			class="text-xl font-semibold pt-0 uppercase text-amber-50"
		>
		Unique Tag Board
		</h1>
		<p
			class="text-xs text-amber-50 pb-0 font-semibold w-[32ch]  text-pretty text-center"
		>
			 A project built with Svelte Kit, TailwindCSS, and Auto-animate, allowing users to dynamically add and remove tags with visual animations. The repository contains frontend code for tag management and may include configurations for Svelte Kit and related tools.
		</p>
	</div>
	<section
	...
	>
		<label for="add-tag-input" class="tag-input">
			<ul
				...
				class="flex flex-row flex-wrap items-center justify-center w-[80vw] bg-slate-900 gap-3 h-[50vh] mb-4"
			>
			...
			<div
				class="  grid place-items-center left-0 w-full h-[content] bg-red-900/20 p-2"
			>
				<label
					for="add-tag-input"
