	...
	<label for="add-tag-input" class="tag-input h-[400px]">
		...
		>
			...
			{#each tags as tag (tag)}
				...
				>
					{tag}<button
						class=" overflow-hidden inline-block whitespace-nowrap rounded-[0.27rem] bg-primary-100 px-[0.65em] pb-[0.25em] pt-[0.35em] text-center align-baseline text-[0.75em] font-bold leading-none text-primary-700 dark:bg-slate-300 dark:text-primary-500"
