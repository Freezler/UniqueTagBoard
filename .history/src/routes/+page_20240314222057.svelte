...
<style>
	button {
		background-image: linear-gradient(45deg, #828bef, #9718b6, #6c0762, #e63aaf, rgb(47, 12, 154));
		box-shadow: 0 0 5px #ab0, 0 0 25px #ab0, 0 0 50px #ab0, 0 0 100px #ab0;
	}
	...
	button:hover {
		scale: 1.02;
		background-image: linear-gradient(45deg, #3dcae9, #828bef, #9718b6, #6c0762, #e63aaf, rgb(47, 12, 154));
		box-shadow: 0 0 5px #ab0, 0 0 25px #ab0, 0 0 50px #ab0, 0 0 100px #ab0;
