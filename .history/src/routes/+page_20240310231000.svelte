...
<body class="bg-slate-950 h-screen">
	...
	>
		...
		<p class="text-xs text-amber-50 pb-2 font-semibold w-[35ch] text-pretty text-center">
	...
	>
		<label for="add-tag-input" class="tag-input">
			...
			>
				<label
					for="add-tag-input"
					class="pl-2 text-xl text-fuchsia-350 font-semibold pb-1 mb-2 pt-1 rounded-[0.27rem] bg-slate-900"
					>Add a tag</label
				>
				<input
