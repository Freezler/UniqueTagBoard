	...
	<label for="add-tag-input" class="tag-input ">
		...
		>
			...
			{#each tags as tag (tag)}
				...
				>
					{tag}<button
						class=" inline-block whitespace-nowrap rounded-[0.27rem] bg-primary-100 pl] pb-[0.4em] pt-[0.35em] text-center align-baseline text-[0.75em] font-bold leading-none text-primary-700 dark:bg-slate-900 dark:text-primary-500"
