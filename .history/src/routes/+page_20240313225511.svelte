		...
		<label for="add-tag-input" class="tag-input">
			...
			>
				...
				<div class="flex items-center flex-1 ">
					<li
						class="flex-1 h-[40px] m-1 bg-red-400"
					>
						{tag}</li>
						<span
							class="flex-1  h-[40px] m-1 box-border bg-blue-500 text-center text-[var(--text-color)] rounded-tr-[0.25rem] rounded-br-[0.25rem] max-w-3"
							tabindex="0"
							role="button"
							on:click={() => remove(tag)}
							on:keydown={(e) =>
